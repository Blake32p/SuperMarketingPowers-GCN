module.exports = {
  siteTitle: 'Marketing Super Powers',
  ...
  authorUrl: 'https://marketingsuperpowers.com/about/', // URL used for author and publisher schema, can be a social profile or other personal site
  userTwitter: '@twitter', // Change for Twitter Cards
  shortTitle: 'MSP App', // Used for App manifest e.g. Mobile Home Screen
